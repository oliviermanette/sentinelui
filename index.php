...
<DOCTYPE html>
  ...
  <div align="center" id="mapid" style="width: 600px; height: 400px;"></div>
    ...
    $("#getData").submit(function(event) {
      ...
      $.ajax({
        ...
        success:function(data)
        {
          ...
          $("chart-display-container-all#row-chart").remove();
          //$('#resultcontainer').html(data);
          ...
          console.log("Numbre spectre : ", numberOfSpectre);
          for (i = 0; i < numberOfSpectre; i++) {
            console.log("Spectre number : ", i);
            var name_canva = "canva_"+String(i);
            console.log(name_canva);
            var name_spectre_data = "spectre_"+String(i);
            var spectre_i = spectre_data_json[name_spectre_data];
            console.log("spectre i :", spectre_i);
            drawSpectreFromData(spectre_i,name_canva);
            console.log("DRAW OK");
          }
          console.log(choc_data_json);
          //  <canvas id="canvas2" height="450" width="600"></canvas>
