...
if($_SERVER["REQUEST_METHOD"] == "POST"){
  ...
  && empty($firstname_err) && empty($lastname_err) && empty($email_err)){
    ...
    $sql = "INSERT INTO user (username, password, email, group_name, first_name, last_name) VALUES (?, ?, ?, ?, ?, ?)";

    if($stmt = mysqli_prepare($link, $sql)){
      // Bind variables to the prepared statement as parameters
      mysqli_stmt_bind_param($stmt, "ssssss", $param_username, $param_password, $param_email, $param_groupname, $param_firstname, $param_lastname );
