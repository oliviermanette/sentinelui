...
function modules() {
  // Bootstrap JS
  var bootstrapDatePickerJS = gulp
    .src("./vendor/bootstrap-daterangepicker/daterangepicker.js")
    .pipe(gulp.dest("./public/vendor/bootstrap-daterangepicker/js"));
  var bootstrapDatePickerCSS = gulp
    .src("./vendor/bootstrap-daterangepicker/daterangepicker.css")
    .pipe(gulp.dest("./public/vendor/bootstrap-daterangepicker/css"));
  // Bootstrap JS
  var bootstrapJS = gulp
    .src("./vendor/bootstrap/dist/js/*")
    .pipe(gulp.dest("./public/vendor/bootstrap/js"));
  // Bootstrap CSS
  var bootstrapCSS = gulp
    .src("./vendor/bootstrap/dist/css/*")
  ...
  // ChartJS
  var chartJS = gulp
    .src("./vendor/chart.js/dist/*.js")
    .pipe(gulp.dest("./public/vendor/chart.js"));
  var chartJSdatalabel = gulp
    .src("./vendor/chartjs-plugin-datalabels/dist/*.js")
    .pipe(gulp.dest("./public/vendor/chartjs-plugin-datalabels.js"));
  // Semantic UI
  var semantic = gulp
    .src(["./vendor/semantic/dist/*.js", "./vendor/semantic/dist/*.css"])
  ...
  var fontAwesome = gulp
    .src("./vendor/components-font-awesome/**/*")
    .pipe(gulp.dest("./public/vendor/font-awesome"));
  // Lightbox
  var lightbox = gulp
    .src("./node_modules/lightbox2/**/*")
    .pipe(gulp.dest("./public/vendor/lightbox"));
  // jQuery
  var jquery = gulp
    .src(["./vendor/jquery/dist/*", "!./vendor/jquery/dist/core.js"])
    .pipe(gulp.dest("./public/vendor/jquery"));
  // jQuery validation
  var jqueryValidation = gulp
    .src(["./vendor/jquery-validation/dist/*.js"])
...
function clean() {
  return plugins.del([
    "./public/vendor/*",
    "./public/css/sentive-admin.css",
    "./public/css/sentive-admin.min.css",
  ]);
}
...
function css() {
  return gulp
    ...
    .pipe(
      plugins.sass({
        //// Converts Sass to CSS with gulp-sas
        outputStyle: "nested",
        includePaths: "./vendor",
      })
    )
...
function watchFiles() {
  ...
  gulp.watch(
    ["./App/Views/**/*.html", "./public/js/**/*.js", "./**/*.php"],
    browserSyncReload
  );
}
